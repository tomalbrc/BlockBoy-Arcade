...
import eu.rekawek.coffeegb_mc.cpu.InterruptManager.InterruptType;
import eu.rekawek.coffeegb_mc.gpu.phase.*;
import eu.rekawek.coffeegb_mc.memory.Dma;
import eu.rekawek.coffeegb_mc.memory.Ram;

import java.io.Serializable;

import static eu.rekawek.coffeegb_mc.gpu.GpuRegister.*;
