...
import eu.rekawek.coffeegb_mc.gpu.phase.OamSearch.SpritePosition;

import java.io.Serializable;

import static eu.rekawek.coffeegb_mc.cpu.BitUtils.toSigned;
import static eu.rekawek.coffeegb_mc.gpu.GpuRegister.LY;
